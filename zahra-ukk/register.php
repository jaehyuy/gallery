...
<html lang="en">
    <head>
        ...
        <title>Register Page - Gallery</title>
                            ...
                            <div class="col-lg-5">
                                <div class="card transparent-card mt-5"> 
                                    <div class="card-header bg-transparent text-center">
                                        <img src="assets/landing/reg.png" alt="Register" class="header-image">
                                    </div>
                                    <div class="card-body text-center">
                                        <form action="config/relog/regist.php" method="post" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label for="inputUsername" class="label-font">Username</label>
                                                <input type="text" class="form-control text-center" name="username" placeholder="Enter your username" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword" class="label-font">Password</label>
                                                <input type="password" class="form-control text-center" name="password" placeholder="Enter your password" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword" class="label-font">Email</label>
                                                <input type="text" class="form-control text-center" name="email" placeholder="Enter your email" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword" class="label-font">Full Name</label>
                                                <input type="text" class="form-control text-center" name="namalengkap" placeholder="Enter your full name" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="inputPassword" class="label-font">Address</label>
                                                <input type="text" class="form-control text-center" name="alamat" placeholder="Enter your address" required>
                                            </div>
                                            <div class="form-group">
                                                <label class="label-font">File</label>
                                                <input type="file" name="foto" class="form-control fc" required>
                                            </div>
                                            <button type="submit" name="regist" class="btn btn rounded-pill btn-block mt-5">Register</button>
                                        </form>
                                    </div>
                                    <div class="card-footer bg-transparent text-center">
                                        <small><a href="login.php" class="link-reg">Already Have an Account? Login!</a></small>
                                    </div>
                                </div>
                            </div>
                        </div>
